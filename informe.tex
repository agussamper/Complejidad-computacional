...
\noindent\fbox{\begin{minipage}{\dimexpr\textwidth-2\fboxsep-2\fboxrule\relax}
 \subsection*{La conjetura de Edmonds}
        ...
        \end{align*}
\indent Esta conjetura también fue propuesta por Edmonds en 1965 y está fuertemente respaldada por evidencia empírica. Se sabe que la mayoría de los problemas que sabemos que pertenecen a $\textit{$\mathcal{N}\mathcal{P}$} \cap \textit{co-$\mathcal{N}\mathcal{P}$}$
\end{minipage}}
